...
import styles from './VideoModelCompare.module.css';

interface VideoModelCompareProps {
  pricing: VideoModelPricing[];
}

const MAX_COMPARE = 5;

export function VideoModelCompare({ pricing: initialPricing }: VideoModelCompareProps) {
