...
import styles from './VideoPriceHistoryChart.module.css';

interface VideoPriceHistoryChartProps {
...
export function VideoPriceHistoryChart({ history }: VideoPriceHistoryChartProps) {
