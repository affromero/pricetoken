...
import styles from './AvatarPriceHistoryChart.module.css';

interface AvatarPriceHistoryChartProps {
...
export function AvatarPriceHistoryChart({ history }: AvatarPriceHistoryChartProps) {
